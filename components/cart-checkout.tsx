...
export function CartCheckoutPage({ brand, initialItems, cartToken }: { brand: Brand; initialItems: HandoffCartItem[]; cartToken: string }) {
  ...
  const displayedDiscount = quote ? quote.totals.discountCents : 0;
